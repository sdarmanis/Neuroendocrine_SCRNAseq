...
```{r Write tables}
write.table(data.temp, paste(dir,"input/secondary_input/GC_table_ALL_datasets_ND.tsv",sep=""))
write.table(meta.temp, paste(dir,"input/secondary_input/Metadata_ALL_datasets_ND.tsv",sep=""))
```