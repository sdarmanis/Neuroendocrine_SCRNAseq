...
data_adult <- read.table(paste(dir,"input/master_input/GC_table_PN_NE_all_manuscript.tsv",sep=""), check.names = F)
meta_adult_new <- read.csv(paste(dir,"input/master_input/Metadata_PN_all_for_manuscript.csv",sep=""), check.names = F, sep = ",", header=T)
...
```{r }
write.table(data_adult, paste(dir,"input/secondary_input/GC_table_PN_NE_all_manuscript_after_Scrublet.tsv",sep=""))
write.table(meta_adult_new, paste(dir,"input/secondary_input/Metadata_PN_all_for_manuscript_after_Scrublet.tsv",sep=""))
```
...
Save data and metadata 
```{r }
write.table(data_adult_ND, paste(dir,"input/secondary_input/GC_table_PN_NE_all_manuscript_after_Scrublet_ND.tsv",sep=""))
write.table(meta_adult_new_ND, paste(dir,"input/secondary_input/Metadata_PN_all_for_manuscript_ND.tsv",sep=""))
```
...
```{r Load data}
data_adult <- read.table(paste(dir,"input/secondary_input/GC_table_PN_NE_all_manuscript_after_Scrublet_ND.tsv",sep=""))
meta_adult_new <- read.table(paste(dir,"input/secondary_input/Metadata_PN_all_for_manuscript_ND.tsv",sep=""))
```
